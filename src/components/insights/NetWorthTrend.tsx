  ...
  return (
    <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-6">
      ...
      <div className="rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-950 border border-neutral-800 p-8 text-center mb-4">
        <div className="text-[11px] text-neutral-500 uppercase tracking-widest">Total Net Worth</div>
        <div className="text-4xl font-bold text-white mt-2 tabular-nums">{formatCAD(currentCAD)} <span className="text-lg font-normal text-neutral-500">CAD</span></div>
        <div className="text-lg text-neutral-400 mt-1 tabular-nums">{formatCAD(currentUSD)} USD</div>
        <div className="text-xs text-neutral-600 mt-3">As of {today}</div>
      </div>
